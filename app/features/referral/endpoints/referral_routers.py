...
from .referral_invitees import router as referral_invitees_router

referral_router = APIRouter()

# /get_code エンドポイントを含める
referral_router.include_router(referral_code_router, prefix="", tags=["Referral"])
# /invitees エンドポイントを含める
referral_router.include_router(referral_invitees_router, prefix="", tags=["Referral"])
